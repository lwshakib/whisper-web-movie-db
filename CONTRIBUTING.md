...
*   Follow the style guides (TypeScript/React best practices).
...
*   Define interfaces for all props and data objects.
...
## Contact
If you have questions, feel free to reach out to the project maintainer: [@lwshakib](https://github.com/lwshakib).
